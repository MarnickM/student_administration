...
@php
    ...
    $style = $options[$type] ?? $options['success']// Dit zegt als je iets ingeeft dat niet in de opties staat geef dan succes mee en geen error
// $options[$type] linkt de type bij @props aan $options. Als je inplaats van type aaa zou zetten en $options[$aaa] zou doen zou het werken met aaa inplaats van type
@endphp
